...
{
	public static readonly Athlete Athlete1 = new() { ID = 123, Name="A1", Category = Category.M, Age = 20, DateOfBirth = DateTime.Parse("1/1/2000") };
	public static readonly Athlete Athlete2 = new() { ID = 234, Name="A2", Category = Category.F, Age = 20, DateOfBirth = DateTime.Parse("1/1/2000") };
	public static readonly Athlete Athlete3 = new() { ID = 345, Name="A3", Category = Category.M, Age = 30, DateOfBirth = DateTime.Parse("1/1/1990") };
	public static readonly Athlete Athlete4 = new() { ID = 456, Name="A4", Category = Category.F, Age = 30, DateOfBirth = DateTime.Parse("1/1/1990") };
	public static readonly Athlete Private = new() { ID = 567, Name="AP", Category = Category.F, Age = 40, DateOfBirth = DateTime.Parse("1/1/1980"), Private = true };
	...
	[
		new() { Course = SimilarCourse, Athlete = Athlete1, StartTime = new Date(DateTime.Parse("2/1/2020")), Duration = new Time(TimeSpan.FromSeconds(100)) },
		new() { Course = SimilarCourse, Athlete = Athlete2, StartTime = new Date(DateTime.Parse("2/3/2020")), Duration = new Time(TimeSpan.FromSeconds(105)) },
		new() { Course = SimilarCourse, Athlete = Athlete3, StartTime = new Date(DateTime.Parse("2/7/2020")), Duration = new Time(TimeSpan.FromSeconds(110)) },
		new() { Course = SimilarCourse, Athlete = Athlete4, StartTime = new Date(DateTime.Parse("2/5/2020")), Duration = new Time(TimeSpan.FromSeconds(96)) }
	];
}