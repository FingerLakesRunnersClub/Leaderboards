...
public static class LeaderboardData
{
	...
	public static readonly Course[] Courses = [new() { Race = Race, Distance = Distance, Results = Results }];

	private static Result[] Results
		=>
		[
			new() { Course = Course, Athlete = Athlete1, StartTime = new Date(DateTime.Parse("1/2/2020")), Duration = new Time(new TimeSpan(1, 2, 3)), CommunityStars = { [StarType.GroupRun] = true, [StarType.Story] = true } },
			new() { Course = Course, Athlete = Athlete1, StartTime = new Date(DateTime.Parse("1/5/2020")), Duration = new Time(new TimeSpan(1, 23, 45)), CommunityStars = { [StarType.Story] = true } },
			...
			new() { Course = Course, Athlete = Athlete3, StartTime = new Date(DateTime.Parse("1/4/2020")), Duration = new Time(new TimeSpan(3, 2, 1)), CommunityStars = { [StarType.Story] = true } },
			...
			new() { Course = Course, Athlete = Athlete4, StartTime = new Date(DateTime.Parse("1/8/2020")), Duration = new Time(new TimeSpan(4, 3, 2)), CommunityStars = { [StarType.GroupRun] = true, [StarType.Story] = true } },
