...
public static class LeaderboardData
{
	...
	private static IEnumerable<Result> Results
		=> new List<Result>
		{
				...
				new() {Course = Course, Athlete = Athlete1, StartTime = new Date(DateTime.Parse("1/5/2020")), Duration = new Time(new TimeSpan(1, 23, 45))},
				new() {Course = Course, Athlete = Athlete2, StartTime = new Date(DateTime.Parse("1/6/2020")), Duration = new Time(new TimeSpan(2, 3, 4))},
				...
				new() {Course = Course, Athlete = Athlete3, StartTime = new Date(DateTime.Parse("1/4/2020")), Duration = new Time(new TimeSpan(3, 2, 1))},
				new() {Course = Course, Athlete = Athlete3, StartTime = new Date(DateTime.Parse("1/9/2020")), Duration = new Time(new TimeSpan(3, 21, 0))},
				new() {Course = Course, Athlete = Athlete4, StartTime = new Date(DateTime.Parse("1/8/2020")), Duration = new Time(new TimeSpan(4, 3, 2))},
				new() {Course = Course, Athlete = Athlete4, StartTime = new Date(DateTime.Parse("1/10/2020")), Duration = new Time(new TimeSpan(4, 32, 10))},
