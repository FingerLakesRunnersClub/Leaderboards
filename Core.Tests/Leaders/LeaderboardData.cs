...
public static class LeaderboardData
{
	...
	public static readonly IReadOnlyCollection<Course> Courses = new[]
	{
	...
	private static IReadOnlyCollection<Result> Results
		=> new List<Result>
		{
			new() { Course = Course, Athlete = Athlete1, StartTime = new Date(DateTime.Parse("1/2/2020")), Duration = new Time(new TimeSpan(1, 2, 3)), CommunityStars = { [StarType.Story] = true, [StarType.ShopLocal] = true } },
			new() { Course = Course, Athlete = Athlete1, StartTime = new Date(DateTime.Parse("1/5/2020")), Duration = new Time(new TimeSpan(1, 23, 45)), CommunityStars = { [StarType.Story] = true, [StarType.ShopLocal] = true } },
			new() { Course = Course, Athlete = Athlete2, StartTime = new Date(DateTime.Parse("1/6/2020")), Duration = new Time(new TimeSpan(2, 3, 4)), CommunityStars = { [StarType.Story] = true } },
			...
			new() { Course = Course, Athlete = Athlete3, StartTime = new Date(DateTime.Parse("1/4/2020")), Duration = new Time(new TimeSpan(3, 2, 1)), CommunityStars = { [StarType.Story] = true, [StarType.ShopLocal] = true } },
			new() { Course = Course, Athlete = Athlete3, StartTime = new Date(DateTime.Parse("1/9/2020")), Duration = new Time(new TimeSpan(3, 21, 0)), CommunityStars = { [StarType.Story] = true } },
			new() { Course = Course, Athlete = Athlete4, StartTime = new Date(DateTime.Parse("1/8/2020")), Duration = new Time(new TimeSpan(4, 3, 2)), CommunityStars = { [StarType.Story] = true } },
			new() { Course = Course, Athlete = Athlete4, StartTime = new Date(DateTime.Parse("1/10/2020")), Duration = new Time(new TimeSpan(4, 32, 10)), CommunityStars = { [StarType.Story] = true } },
